...
public function injectResponse() {
    $this->baseResponses = [
        "Salutations" => ["Hello" => "Hi there!", "Greetings" => "Hello! How can I assist you today?",
        ...
        "Farewells" => ["Goodbye" => "Goodbye! Have a great day!", "See you later" => "See you later! Take care!",
        ...
        "Common knowledge" => ["What is your name?" => "I am Ada, chatbot created to assist you.",
        "What is 2 +2?" => "2 + 2 = 4",
